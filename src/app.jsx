...
const CARDS_LIST = ["EM-TRANSITION TO DISCIPLINE", "EM-CORE", "EM-FOUNDATION", "EM-TRANSITION TO PRACTICE", "ANESTHESIA", "CARDIO", "ICU", "GENERAL SURGERY", "GENERAL INTERNAL MEDICINE", "NEURO", "OPTHO", "ORTHO", "PLASTICS", "TOXICOLOGY", "TRAUMA", "OBS-GYN", "PICU", "PSYCH", "FAMILY MEDICINE", "TRANSPORT MEDICINE"];
